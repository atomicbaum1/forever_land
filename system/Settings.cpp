...
// TODO: Load settings from a file
    void Settings::loadSettings(const char *configFile) {
       ...
       if (configFile == NULL) {
          ...
          _displaySettings.width = atoi(
                  settingsDocument.FirstChildElement("Settings")->FirstChildElement("Display")->Attribute("width"));
          _displaySettings.height = atoi(
                  settingsDocument.FirstChildElement("Settings")->FirstChildElement("Display")->Attribute("height"));
          _displaySettings.windowed = textToBoolean(
                  settingsDocument.FirstChildElement("Settings")->FirstChildElement("Display")->Attribute("windowed"));
          ...
          _worldManifestName = settingsDocument.FirstChildElement("Settings")->FirstChildElement(
                  "GameWorldManifest")->GetText();

          // Get the starting world name
          _startingWorld = settingsDocument.FirstChildElement("Settings")->FirstChildElement(
                  "StartingWorld")->GetText();
